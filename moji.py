...
class Moji(object):
    ...
    #     # return word
        ...
        # subdetailsID=dict()
        # # print(json.dumps(text))
        # subdetailsID['word_Part_of_speech']=dict()
        # for por in text['details']:
        #     subdetailsID['word_Part_of_speech'][por['objectId']]=por['title']
        # subdetailsID['subdetails']=dict()
        # for subdetails in text['subdetails']:#释义
        #     if subdetails['detailsId'] in subdetailsID['word_Part_of_speech'].keys():
        #         subdetailsID['subdetails'][subdetails['objectId']]={
        #             'title':subdetails['title'],
        #             'examples':[],
        #         }
        # try:
        #     for examples in text['examples']:
        #         if examples['subdetailsId'] in subdetailsID['subdetails'].keys():
        #             subdetailsID['subdetails'][examples['subdetailsId']]['examples'].append((examples['objectId'],examples['title'],examples['trans']))
        #         else:
        #             # print(examples['subdetailsId'])
        #             pass #解决例子不正确
        # except:
        #     pass
        # return subdetailsID
